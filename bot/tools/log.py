...
This is the AlderBot logger. It provides a simple interface for providing
ANSI-colored, formatted logging messages. Utilize LEVEL from the configuration
to increase or decrease logging level.
"""
